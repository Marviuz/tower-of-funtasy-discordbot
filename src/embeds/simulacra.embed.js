  ...
  const embed = {
    basicDetails: {
      ...
      fields: [
        ...
        { name: 'Element', value: element.toUpperCase(), inline: true },
        { name: 'Type', value: type.toUpperCase(), inline: true },
        { name: 'Base Stats', value: baseStats.map($ => $.charAt(0).toUpperCase() + $.slice(1)).join(', ') },
        { name: 'Shatter', value: `${shatter.rank} — ${shatter.value.toFixed(2)}`, inline: true },
        { name: 'Charge', value: `${charge.rank} — ${charge.value.toFixed(2)}`, inline: true },
      ],
